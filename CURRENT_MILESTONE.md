...
## Current Checkpoint - Phase G (Assurance Architecture) Authorized by Bora (2026-09-14)
...
CURRENT PHASE (distinct from the prior phase/prior-prior phase/prior-prior-prior phase/milestone above; freshly authorized by Bora, no substantive operator work performed yet):
...
Phase G's own coupled state (read together): **BORA_AUTHORIZED / SELECTED / NOT_YET_COMPLETED / READ_ONLY_DESIGN_ONLY**.
