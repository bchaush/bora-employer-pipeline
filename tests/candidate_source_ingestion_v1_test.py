...
assert_true(ev_result["records_checked"] == 42, f"expected 42 Evidence records (37 prior + 3 initial + 2 human-source-resolution: DCOMMERCE_REFERENCE_001, DCOMMERCE_LINKEDIN_PERIOD_001), got {ev_result['records_checked']}")
