...
# The checkpoint's own archived Phase E completed_actions narrative must
# never combine the two distinct Family 1 stale-role identities (Fresenius
...
assert 'Fresenius Medical Care R0266808' in phase_e_reference
assert 'MGB RQ4055007' in phase_e_reference
...
assert 'three executability classes' not in phase_e_reference, (
    'stale three-executability-class summary reintroduced in checkpoint phase_e_completed_actions_reference'
)
