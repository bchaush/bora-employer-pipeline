...
assert_true(real["records_checked"] == 4, f"expected 4 records, got {real['records_checked']}")
assert_true(real["index"] is not None, "trusted Experience index missing")
assert_true(
    list(real["index"].keys()) == ["EXP_EDU_BRANDEIS_001", "EXP_MM_001", "EXP_TELUS_001", "EXP_WW_001"],
