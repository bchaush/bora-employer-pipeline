...
# prior_prior_phase -- never conflated with Phase F's own operator-completed
# status.
...
assert 'operator completion only' in completed.lower()
...
# FINAL hardened Phase F completion facts (Phase F's own coupled state,
