...
assert_true(len(ev_result["index"]) == 42, "Evidence count must be 42 (36 prior + 1 new TELUS end-date record + 3 CANDIDATE_SOURCE_INGESTION_V1 records + 2 human-source-resolution records)")
