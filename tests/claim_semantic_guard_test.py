...
assert_true(r_proc["reusable"] is True, "CLAIM_WW_006 must be reusable after approval")
assert_true(r_proc["human_approved"] is True, "CLAIM_WW_006 must be human-approved")
assert_true(
    "FORBIDDEN_SEMANTIC_PATTERN" not in error_codes(r_proc),
    f"CLAIM_WW_006 semantic guard: {r_proc['errors']}",
)
print("PASS 8c: CLAIM_WW_006 approved reusable passes semantic guard.")
