...
def attach_current_verification(job_input: dict[str, Any], fixture_id: str) -> dict[str, Any]:
    run_id = f"RUN_GOLDEN_CURRENT_{fixture_id}"
    url = f"https://careers.example.test/jobs/{fixture_id}"
...
def evaluate_fixture(
    ...
    *,
    ...
    attach_current_verification(job_input, fixture_id)
