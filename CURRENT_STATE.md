...
* Pursuit Approval Boundary v1 (`PURSUIT_APPROVAL_BOUNDARY_ARCHITECTURE_V1`) (**ARCHITECTURE RECORDED / IMPLEMENTATION DEFERRED**):
  ...
  * Accepted ADR: `docs/decisions/ADR-PURSUIT-APPROVAL-BOUNDARY-V1.md` (untracked, not yet committed; two Cursor adversarial reviews, second verdict `ACCEPT_ADR_DRAFT`; one residual exploratory/consequential-boundary scoping note adjudicated `ACCEPTABLE_ARCHITECTURE_DEFERRAL`, not a contradiction).
