...
Active milestone pointer: see `CURRENT_MILESTONE.md` (`Status: READ_ONLY_AUDIT`; active task `ATOMINVEST_REJECT_CAUSALITY_AND_APPLICATION_ACTIONABILITY_AUDIT_V1`, canonical audit baseline `bf1f395ee1d79dec04f7ac39e3d972e48dcbe304`; no implementation or Claim approval authorized; no audit conclusion or next fix preselected). Current reproduced Atominvest result (`fixtures/jobs/CASE_A_ATOMINVEST_IMPLEMENTATION_ANALYST`, unmodified fixture, at this baseline): `decision=REJECT`, `lane=LANE_0_REJECT`, exactly four hard blockers (`REQ_A_CONFIG_IMPLEMENTATION`, `REQ_A_DEGREE`, `REQ_A_EXCEL_DATA`, `REQ_A_QA_TROUBLESHOOTING`), `REQ_A_EXPERIENCE_LEVEL=UNKNOWN`, `REQ_A_ONBOARDING_MIGRATION_UAT=PARTIAL`. Prior pointers remain closed, not reopened: `ACCREDITED_INSTITUTION_QUALIFIER_SEMANTICS_V1` `CLOSED` (implementation SHA `9950c7c3eacdebf741c2e6a990a5b391adba3c44`, state-closure SHA `bf1f395ee1d79dec04f7ac39e3d972e48dcbe304`); `APPROVED_CLAIM_CAPABILITY_MAPPING_CAUSALITY_AUDIT_V1` remains `COMPLETE_ADJUDICATED` (baseline `01142d19fa80400ce94db5f5fa2e85ea01f23e1c`; adjudication result: do not wire MM/TELUS Claims yet, merely because they are approved).
